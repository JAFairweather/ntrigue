...
export const UI = {
  ...
  howtoWhat: 'Four rounds, then the blackmail finale. Each round: a spicy prompt, everyone answers in secret, and you face one person in a game of nerve.',
  howtoObjectiveHead: 'The objective',
  howtoObjective: 'Most points wins the night. Two awards wait at the end: Villain of the night (most 🗡) and Biggest sucker (most times betrayed).',
  howtoRoundHead: 'Each round',
  howtoRound: 'You and your counterpart choose in the dark: SHARE your secret, or HOLD out.',
  howtoMatrix: 'Both SHARE: you read each other’s secrets, +3 each. You SHARE, they HOLD: they read yours and give nothing back — +5 and a 🗡 for them, +1 for you. Both HOLD: +1 each, and nobody learns a thing.',
  howtoFinaleHead: 'The finale',
  howtoFinale: 'Every secret you collect is leverage. One move each, last place goes first: EXTORT (“pay 3 points or it goes public”), BURN it straight to the room (+1), or VAULT it for a quiet +2.',
  howtoStrategyHead: 'Strategy',
  howtoTip1: 'Holding pays, but the 🗡 follows you all night — and villains make tempting targets.',
  howtoTip2: 'Trading arms you for the finale: every secret you read is ammunition later.',
  howtoTip3: 'Write secrets juicy enough to trade, but survivable in public. Nothing can be un-told.',
  howtoTip4: 'Round 2 pairs you with your partner. So does round 4. Plan accordingly.',
  howtoTip5: 'Losing? The finale goes last-place-first. Comebacks are the point.',
