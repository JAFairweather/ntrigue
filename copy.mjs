...
export const UI = {
  ...
  lobbySeatHintFriends: 'Seat people however you like — matchups rotate through the whole table.',
  groupTitle: 'Who’s at the table?',
  groupFriends: 'Friends',
  groupFriendsDesc: 'A mix — singles, friends, whoever. Matchups rotate; round 4 replays the opening as the rematch.',
  groupCouples: 'Couples',
  groupCouplesDesc: 'Couples sit side by side (1+2, 3+4). Rounds 2 and 4 are the couples rounds — round 4 is the money rematch.',
