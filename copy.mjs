...
export const UI = {
  ...
  howtoWhat: 'Four rounds, then a finale. Each round you answer a prompt with a real secret, then you’re matched with one other player.',
  howtoObjectiveHead: 'The goal',
  howtoObjective: 'Most points at the end wins.',
  howtoRoundHead: 'Each round',
  howtoRound: 'You and your match each secretly pick one: SHARE your secret with them, or HOLD it back.',
  howtoMatrix: 'Both share: you swap secrets, 3 points each. Only one shares: the holder reads it, gives nothing back, and takes 5 points — the sharer gets 1. Both hold: 1 point each.',
  howtoFinaleHead: 'The finale',
  howtoFinale: 'One move each, lowest score goes first. Pick a secret you collected and either demand 3 points from its owner (“pay up or everyone hears it”), read it out to the room for 1 point, or stay quiet for 2.',
